...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd; padding-left: 20;">
  <a class="navbar-brand" href="#">Liga Futbol</a>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="{{route ('equips.index')}}">Index Equips</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{route ('partits.index')}}">Index Partits</a>
      </li>
    </ul>
  </div>
